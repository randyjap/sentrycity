...
Rails.application.configure do
  ...
  config.public_file_server.enabled = Rails.application.credentials.rails_configs[:rails_serve_static_files]
  ...
  # config.active_job.queue_name_prefix = "sentrycity_production"
